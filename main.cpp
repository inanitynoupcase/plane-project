...
void QuanLyMayBay_NhapMayBay(){
	...
	taoButton(335+200,600,335+200+40,640,0,4,0,3,"X");
...
//			
			...
			case 21:{
				...
				taoO(458,697,925,727,7,0,22);
//				taoO(458,742 ,925,772,7,0,23);
//				taoO(458,787,925,817,7,0,24);
